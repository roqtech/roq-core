...
exports.MultipleLoader = (0, common_1.createParamDecorator)(async (param, context) => {
    ...
    return ctx[data_loader_interceptor_1.NEST_LOADER_CONTEXT_KEY]
        .getLoader(loaders_1.BaseMultipleEntityLoader, param.repository, param.relationProperty);
});
